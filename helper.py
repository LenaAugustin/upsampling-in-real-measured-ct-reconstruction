...
"""
    Helper file to read and save tiff data
"""
...
def get_mean_increment(list):
    '''

    :param list: list of values, e.g. primary angles
    :return: mean increment from one entry to the next
    '''
    return np.mean(np.diff(np.array(list)))
